...
TODO: screenshot for contactapp
...
TODO: code snippet: WrapperFactory (testing)
...
image::modules/310.png[scaledwidth=75%]
...
image::modules/320.png[scaledwidth=75%]
...
TODO: screenshots/code fragments
