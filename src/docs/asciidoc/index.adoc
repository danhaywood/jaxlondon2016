...
[%notitle]
=== 2005
image::history/2003-dnd.png[width=960px]

[.dan]
[%notitle]
=== 2006
image::history/2005-dsfa.png[width=960px]
...
[%notitle]
=== 2015
image::history/2015-commplan.png[width=960px]
...
link:images/cross-cutting/estatio-security.mp4[demo: security module role/permissions derived from metamodel]
...
_By accepting the constraints of Apache Isis, the "architecture" comes for free and enforces true modularity and separation of concerns_
