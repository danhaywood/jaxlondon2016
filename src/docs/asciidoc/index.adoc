...
* Where is data mastered, owned, copied, changed, accessed?  How is it stored?
* What technical standardisation is available/valuable?

Does Apache Isis help or hinder the evolution of an enterprise's technology architecture?
