...
* Frameworks like Isis try to embody the constraints in the framework
...
Most frameworks are a high commitment "lifestyle choice".  What is being coupled to Isis like?

[%step]

* Constraints on the domain model code?
* Degree of dependence domain code needs on Isis?
* Degree of dependence domain code generally has on Isis?
* Reuse Isis domain models?
* Replace 3rd party components used by Isis?  (e.g. persistence layer ORM)
